...
const homeCourses = [
  {
    ...
    desc: "The exact gig setup, pricing tiers, scripts, and routines I used to generate $127k across 2,019 orders — as a producer nobody knew.",
    bullets: ["5 modules: profile → gig → pricing → briefs → delivery", "Copy-paste gig title, description + buyer-request DMs", "Free pricing calculator included"],
    price: 27,
    tag: "38-page PDF",
  },
  {
    ...
    desc: "How to position mixing, mastering, and production as premium services — and move from $63 to $200+ average order value.",
    bullets: ["Service ladder: beats → mix → full production → retainer", "Price maps by genre + the reference track close", "Briefing template, delivery scripts + follow-up system"],
    price: 27,
    tag: "28-page PDF",
  },
  {
    ...
    bullets: ["Everything in Course 01 + 02", "90-day roadmap + outreach system", "Retention ladder: $30 buyer → $3k client"],
    price: 47,
